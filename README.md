...
- Качество прогноза ограничено объёмом накопленной истории. При небольшом количестве historical data показатель «Точность прогноза» во время ручных проверок обычно находится примерно в диапазоне `50–60%`; это ожидаемое ограничение текущей модели, а не ошибка интерфейса.
